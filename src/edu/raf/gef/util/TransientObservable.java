...
public class TransientObservable {
	 ...
	 */
	public synchronized void addObserver(TransientObserver o) {
		if (o == null)
	 ...
	 */
	public synchronized void deleteObserver(TransientObserver o) {
		obs.removeElement(o);
	}
	...
	public void notifyObservers(Object arg) {
		...
		for (int i = arrLocal.length - 1; i >= 0; i--)
			((TransientObserver) arrLocal[i]).update(this, arg);
	}
